...
"Blunders in behaviour corrected" by An observer of men and things
...
./make_project.py
```
* [x] Read the [project comments](https://www.pgdp.net/c/project.php?id=projectID67a61996d92b1#project-comments)
* [x] Subscribe to the [forum topic](https://www.pgdp.net/phpBB3/viewtopic.php?t=83319) and read all posts
* [x] Open `blunders-utf8.txt` in Guiguts
...
* [x] Use `File → Save a Copy As` to make `blunders.html`
...
* [x] Re-open `blunders-utf8.txt` (if not still open).
...
* [x] Go to [project page](https://www.pgdp.net/c/project.php?id=projectID67a61996d92b1), select SR time period, upload `blunders-sr.zip`
...
* [x] Add **anonymized** files to git, e.g. `blunders-smoothread01.txt`
...
* [x] Enter copyright clearance (get from DP [project page](https://www.pgdp.net/c/project.php?id=projectID67a61996d92b1))
...
* [x] Credits line
  * Paste in from DP [project page](https://www.pgdp.net/c/project.php?id=projectID67a61996d92b1)
